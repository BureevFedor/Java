...
public class Client {
    ...
    private Response receive() {
        try {
            ...
            System.out.println(Thread.currentThread().getName() + " : " + "Похоже, связь с сервером прервалась.");
        } catch (Exception e) {
            System.out.println(Thread.currentThread().getName() + " : " + "Не получилось прочитать ответ из сокета : " + e);
        }
        return null;
    }
    ...
    private void send(Request request) {
        try {
            ...
            System.out.println(Thread.currentThread().getName() + " : " + "Не получилось записать запрос в сокет : " + e);
        }
    }
}